...
<html>
 ...
 <body background="img/Teacher.png">
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
             <li class="active"><a href="teacherDashboard.php">Teacher Dashboard</a></li>
  ...
  <div class="container">
    ...
    <table class="table table-bordered table-striped">
      ...
      <tbody>
        <tr>
          <td>
            <form id="login" style="background-color:hsl(120,100%,75%);">
          ...
          <td>
            <form id="signup" style="background-color:hsl(120,100%,75%);">
              <div class="form-group">
                <label>Name</label>
              ...
              <button class="btn btn-success pull-right">Sign Up</button>
            </form>
          </td>
        </tr>
      </tbody>
     ...
     <!-- FOOTER -->
      <footer style="background:#3276B1; height:120%;text-align: center;color:#fff;">
