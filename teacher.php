        ...
        <div class="modal-content">
          ...
          <hr>
            <div id="add_class_form">
              ...
              <input class="form-control" name="code" placeholder="Code , Eg : CSEC-322">
              ...
              <?php foreach(range(1,12) as $r) echo '<option>'.$r.'</option>'; ?>
              </select>
              <input class="form-control" name="start" placeholder="Starting Roll Number (Eg. ID/Department/Year)">
              <input class="form-control" name="end" placeholder="Ending Roll Number (Eg. 21512111027/CSE/2019)">
